...
export const beginnerWorkouts: Record<string, DayWorkout> = {
  ...
  Tuesday: {
    ...
    exercises: [
      ...
      },
      {
        ...
        sets: 3,
        reps: "20 each leg",
        description: "Front snap kick for hip-flexor speed and control.",
        tip: "Chamber the knee, snap the kick forward, then retract fast. Stay tall and balanced.",
      },
      {
  ...
  Saturday: {
    ...
    exercises: [
      ...
      {
        name: "Front Kick (Fast)",
        sets: 3,
        reps: "20 each leg",
        description: "Explosive front snap kicks for speed development.",
      ...
      },
      {
        ...
        sets: 3,
        reps: "20 each leg",
        description: "Rotational kick for hip power and speed.",
        tip: "Pivot on the standing foot, kick across, and turn your hip over fully.",
      },
      {
